...
1. **Import@ss (sede electrónica de la Seguridad Social)**: el informe de vida laboral detalla todos tus periodos de alta, con fechas de inicio y fin, régimen de encuadramiento y grupo de cotización.
2. **App Import@ss**: disponible para iOS y Android, permite consultar la vida laboral directamente desde el teléfono móvil.
3. **Por SMS**: enviando un mensaje con la palabra "LABORAL" al número 600 123 000 desde el móvil asociado a tu número de Seguridad Social.
4. **Presencialmente**: en oficinas de la TGSS, con cita previa.
